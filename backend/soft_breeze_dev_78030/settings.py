"""
Django settings for soft_breeze_dev_78030 project.
...
ROOT_URLCONF = 'soft_breeze_dev_78030.urls'
...
WSGI_APPLICATION = 'soft_breeze_dev_78030.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "soft_breeze_dev_78030 API",
    "DESCRIPTION": "API documentation for soft_breeze_dev_78030 App",
    "VERSION": "v1",
}
